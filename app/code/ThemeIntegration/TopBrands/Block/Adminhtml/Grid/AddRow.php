...
namespace ThemeIntegration\TopBrands\Block\Adminhtml\Grid;
...
class AddRow extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'ThemeIntegration_TopBrands';
        $this->_controller = 'adminhtml_grid';
        parent::_construct();
        if ($this->_isAllowedAction('ThemeIntegration_TopBrands::add')) {
